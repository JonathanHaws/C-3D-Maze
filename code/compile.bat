...
clang++ -o %output_path%%output_file% -std=c++17 -I. -Ilibs -Ilibs/imgui main.cpp libs/imgui/*.cpp -Llibs -Llibs/GL -Llibs/GLFW -lglfw3 -lopengl32 -lgdi32 -luser32 -lmsvcrt -lshell32 -lglew32s -DGLEW_STATIC -lglu32 -llibcmt -lole32
