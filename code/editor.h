...
struct Editor {
    ...
    void edit(Audio* audio) {
        ...
        camera.flying = !ImGui::IsWindowCollapsed(); // God mode if window is collapsed
        ...
        if (ImGui::CollapsingHeader("Sky")) {
            ImGui::SliderFloat("Sun X", &sky.sun.x, -1.0f, 1.0f); 
            ImGui::SliderFloat("Sun Y", &sky.sun.y, -1.0f, 1.0f);
            ImGui::SliderFloat("Sun Z", &sky.sun.z, -1.0f, 1.0f);
